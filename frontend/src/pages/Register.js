...
const Register = () => {
  ...
  const bgImage = getBgImage('register');
    ...
    >
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Create your account and start watching</p>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <div className="bg-red-500/10 border border-red-500 text-red-500 px-4 py-3 rounded-lg flex items-center space-x-2" data-testid="error-message">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 pl-12 bg-gray-900/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-white"
          ...
          <button
            onClick={googleLogin}
            type="button"
            className="w-full py-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition flex items-center justify-center space-x-2"
